...
import IconAcc from "assets/icons/icon-acc.svg";
import IconUnacc from "assets/icons/icon-unacc.svg";
...
import IconEyeBlack from "assets/icons/icon-eye-black.svg";
